...
export const copy = {
  en: {
    ...
    generationPage: {
      ...
      reviewWorkspace: "Review Workspace",
      reviewCopy:
        "Open the review workspace to refine generated drafts, complete approvals, and prepare them for publication.",
    ...
    components: {
      ...
      reviewCommentPlaceholder: "Optional: add change notes or approval rationale",
  ...
  zh: {
    ...
    generationPage: {
      ...
      laterTask: "后续任务",
      reviewWorkspace: "评审工作台",
      reviewCopy: "进入评审工作台，完善草稿内容、完成审批并准备发布。",
      createTitle: "创建生成任务",
